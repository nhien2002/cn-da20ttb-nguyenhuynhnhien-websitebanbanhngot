...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 06, 2024 lúc 06:10 AM
...
--
-- Đang đổ dữ liệu cho bảng `khachhhang`
--
...
(1, 'Bánh Cupcake bông la', 'img/hinhanh/Banhcupcake1.jpg', '1 tháng', '2023-12-13', 5000, 5, '', 1),
...
(5, 'Bánh CupCake (dâu  tằm)', 'img/hinhanh/product-3.jpg', '15 ngày', '2023-12-20', 20000, 5, 'Bột mì số 8 250 gr<br>\r\n Bột nở 1/2 muỗng cà phê<br>\r\n(baking powder)<br>\r\n Muối nở 1 muỗng cà phê<br>\r\n(baking soda)<br>\r\n Bơ lạt 115 gr<br>\r\n Dâu tây 5 quả<br>\r\n Đường 110 gr<br>\r\n Vani 1 muỗng cà phê<br>\r\n Trứng gà 2 quả<br>\r\n ', 1),
(6, 'Bánh mì ', 'img/hinhanh/Bánhmingot3.jpg', '3 tuần', '2023-12-18', 10000, 1, 'bột mì<br>\r\nnước ấm<br>\r\nmen nở<br>\r\nmuối<br>\r\ngiấm<br>\r\nđường<br>\r\ndầu ăn<br>\r\nsữa tươi.<br>', 1),
(9, 'Bánh CupCake (vị kem)', 'img/hinhanh/product-7.jpg', '15 ngày', '2023-12-22', 20000, 5, '140gram bột mì đa dụng (all purpose flour)<br>\r\n10gram bột cacao nguyên chất (không đường)\r\n3gram muối.<br>\r\n6gram bột nở (baking powder)<br>\r\n2 quả trứng gà (50gram/ quả – không tính vỏ – nhiệt độ phòng)<br>\r\n3ml vanilla dạng lỏng.<br>\r\n230gram kem tươi <br>\r\n125gram đường.<br>', 1),
(10, 'Bánh CupCake Gấu', 'img/hinhanh/banhcupcake.jpg', '15 ngày', '2023-12-22', 20000, 5, '2 quả trứng gà<br>\r\n100 gram bột mì đa dụng<br>\r\n100 gram đường cát<br>\r\n2 muỗng cà phê dầu ăn<br>\r\nPhô mai viên (nếu thích)<br>\r\n', 1),
(11, 'Bánh CupCake (vị socola)', 'img/hinhanh/product-10.jpg', '15 ngày', '2023-12-22', 20000, 5, 'Bột mì<br>\r\nĐường<br>\r\nBột nổi<br>\r\nBột cacao<br>\r\nMuối<br>\r\nHương vanilla tổng hợp.<br>', 1),
...
(26, 'Bánh kem sinh nhật(set 3 bộ)', 'img/hinhanh/Bánh-Kem-Set-3-Cái-Nhỏ-TP-1325.jpg', '', '2023-12-17', 400000, 2, ' bột mì <br> \r\ntrứng <br>\r\nsữa <br> \r\nphô mai,...<br> \r\nTrong bánh kem chứa các chất dinh dưỡng như chất bột đường khá nhiều <br>', 1),
(27, 'Bánh Rau Câu Khai Trương', 'img/hinhanh/12.png', '3 tuần', '2023-12-22', 350000, 4, 'Bột rau câu nguyên chất.<br>\r\nĐường.<br>\r\nSữa tươi.<br>\r\nKem béo.<br>\r\nTrái cây tươi.<br>\r\nMứt/ trái cây sấy. <br>\r\nCốt dừa.<br>\r\nTrứng.<br>', 1),
(28, 'Bánh Rau Câu(hình sân bóng)', 'img/hinhanh/Rau-Câu-Flan-Sân-Banh-TP-1001.jpg', '3 tuần', '2023-12-27', 200000, 4, 'Bột rau câu nguyên chất.<br>\r\nĐường.<br>\r\nSữa tươi.<br>\r\nKem béo.<br>\r\nTrái cây tươi.<br>\r\nMứt/ trái cây sấy. <br>\r\nCốt dừa.<br>\r\nTrứng.<br>', 1),
...
(31, 'Bánh mì ngọt(chà bông)', 'img/hinnhanh/cach-lam-banh-mi-cha-bong-sot-dau-trung-beo-thom-mem-min-202203312340565701.jpg', '3 tuần', '2023-12-20', 10000, 1, 'bột mì/bột ngũ cốc <br>\r\n đường <br>\r\n bơ <br>\r\n sữa <br>', 1),
(32, 'Bánh mì ngọt(nho khô)', 'img/hinhanh/21558617_298499030557732_2182532647471422160_n.jpg', '15 ngày', '2023-12-26', 20000, 1, 'bột mì<br>\r\n đường<br>\r\n sữa <br>\r\n trứng gà<br>\r\n nho khô ...<br>', 1),
(33, 'Bánh mì ngọt(than tre)', 'img/hinhanh/harper-bazaar-banh-mi-den-giam-can-1.jpg', '15 ngày', '2023-12-31', 25000, 1, 'Dough bánh mì - 1000gr <br>\r\nbột mì 13. - 100gr <br>\r\nđường cát. - 12gr <br>\r\nmuối. - 15gr <br>\r\nmen khô ngọt. - 100gr<br>\r\n whipping cream Oldenburger. - 450gr <br>\r\nsữa tươi Oldenburger.<br>\r\nKem bơ phô mai. - 100gr<br>\r\n cream cheese CSF. - 25gr<br> \r\nwhipping cream. Oldenburger. - 200gr <br>\r\nbơ lạt Arla Pro. - 80gr<br>\r\n lòng đỏ - 30gr đường xay. ...\r\nTopping crumble.<br>', 1),
(34, 'Bánh mì ngọt(ngũ cốc)', 'img/hinhanh/images (1).jpg', '15 ngày', '2023-12-26', 20000, 1, 'bột mỳ đen <br>\r\nloại bột mỳ với hương vị đặc biệt có nồng độ chất xơ cao<br.\r\n ít chất béo cùng nho khô <br>\r\n 5 loại hạt: lúa mạch, yến mạch, ngô, kê, gạo lứt chứa nhiều axit amin và vitamin.<br>', 1);
...
--
ALTER TABLE `sanpham`
  MODIFY `Masp` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
